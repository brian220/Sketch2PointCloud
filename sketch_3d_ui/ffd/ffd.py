...
from sketch_3d_ui.ffd.ffd_utils import fit_affine_transformation, angles2matrix
...
class FFD:
    ...
    def init_parameters(self, 
        ...
        self.array_mu_x = array_mu_x
        self.array_mu_y = array_mu_y
        self.array_mu_z = array_mu_z

    def update_move(self, array_mu_x, array_mu_y, array_mu_z):
        self.array_mu_x = array_mu_x
        self.array_mu_y = array_mu_y
        self.array_mu_z = array_mu_z
    ...
    def __call__(self, src_pts):
        ...
        shifted_reference_frame_pts = self.T(src_reference_frame_pts)
